        ...
        <div className='LocationContentSection' >
            <LocationCard>
                ...
                <div style={{display:'flex', alignItems:'center', gap:"1rem"}}>
                    < i style={{color:'#9734A6', fontSize:'20px'}} className="fa-solid fa-location-dot"></i>
                    <SmallText style={{fontWeight:'bold'}}>Survey No 548/2/1/1 Gowdavelli Village, Medchal , malkajgiri.
                    Pin : 501401</SmallText>
                </div>
                <div style={{display:'flex', alignItems:'center', gap:"1rem"}}>
                    < i style={{color:'#9734A6', fontSize:'20px'}} className="fa-solid fa-phone-volume"></i>
                    <SmallText style={{fontWeight:'bold'}}>+91 7674830405</SmallText>
                </div>
                <div style={{display:'flex', alignItems:'center', gap:"1rem"}}>
                    < i style={{color:'#9734A6', fontSize:'20px'}} className="fa-regular fa-envelope"></i>
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3802.7873495702556!2d78.4576463!3d17.61283!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb8900339a7a03%3A0x64efc585102ee8b3!2sVAISHNAVI%20BRICKS!5e0!3m2!1sen!2sin!4v1730189186319!5m2!1sen!2sin" width="600" height="450"></iframe>
        </div>
